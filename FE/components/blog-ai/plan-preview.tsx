...
export function PlanPreview({ plan, onApprove, onReject, isReadOnly = false }: PlanPreviewProps) {
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          {!isReadOnly ? (
            ...
            <span className="text-xs uppercase tracking-wider font-medium bg-green-100 text-green-800 px-2 py-0.5 rounded-md">
              Approved
            </span>
          )}
        </div>
